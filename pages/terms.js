    ...
    <div className="container">
      <div className="row">
        <div className="col-md-12">
          ...
          <p>Welcome to SimilarFont.io!</p>

          <p>
            These terms and conditions outline the rules and regulations for the
            use of SimilarFont.io's Website, located at https://similarfont.io/.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use SimilarFont.io if you do not
          ...
          <p>
            We employ the use of cookies. By accessing SimilarFont.io, you
            agreed to use cookies in agreement with the SimilarFont.io's Privacy
            Policy.{" "}
          </p>
          ...
          <p>
            Unless otherwise stated, SimilarFont.io and/or its licensors own the
            intellectual property rights for all material on SimilarFont.io. All
            intellectual property rights are reserved. You may access this from
            SimilarFont.io for your own personal use subjected to restrictions
            set in these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from SimilarFont.io</li>
            <li>Sell, rent or sub-license material from SimilarFont.io</li>
            <li>Reproduce, duplicate or copy material from SimilarFont.io</li>
            <li>Redistribute content from SimilarFont.io</li>
          </ul>
          ...
          <p>
            ...
            SimilarFont.io does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the
            views and opinions of SimilarFont.io,its agents and/or affiliates.
            ...
            SimilarFont.io shall not be liable for the Comments or for any
          ...
          <p>
            SimilarFont.io reserves the right to monitor all Comments and to
          ...
          <p>
            You hereby grant SimilarFont.io a non-exclusive license to use,
          ...
          <p>
            ...
            SimilarFont.io; and (d) the link is in the context of general
          ...
          <p>
            ...
            sending an e-mail to SimilarFont.io. Please include your name, your
          ...
          <p>
            No use of SimilarFont.io's logo or other artwork will be allowed for
